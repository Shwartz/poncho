          ...
          <div className='flex flex-wrap'>
              ...
              <div
                ...
                <div className='flex flex-row items-center'>
                  ...
                  <div className='flex-1 text-right md:text-center'>
                    ...
                    <h3 className='font-bold text-3xl'>$3249 <span className='text-green-500'>
                      <i className='fas fa-caret-up' /></span>
                    </h3>
                  </div>
                </div>
              </div>
            ...
            <div className='w-full md:w-1/2 xl:w-1/3 p-6'>
              ...
              <div
                ...
                <div className='flex flex-row items-center'>
                  <div className='flex-shrink pr-4'>
                    <div className='rounded-full p-5 bg-pink-600'><i className='fas fa-users fa-2x fa-inverse' />
                    </div>
                  </div>
                  <div className='flex-1 text-right md:text-center'>
                    <h5 className='font-bold uppercase text-gray-600'>Total Users</h5>
                    <h3 className='font-bold text-3xl'>249 <span className='text-pink-500'>
                ...
                <div className='flex flex-row items-center'>
                  <div className='flex-shrink pr-4'>
                    <div className='rounded-full p-5 bg-yellow-600'><i
                      className='fas fa-user-plus fa-2x fa-inverse' /></div>
                  </div>
                  <div className='flex-1 text-right md:text-center'>
                    <h5 className='font-bold uppercase text-gray-600'>New Users</h5>
                    <h3 className='font-bold text-3xl'>2 <span className='text-yellow-600'>
                      <i className='fas fa-caret-up' /></span>
                    </h3>
                  </div>
                </div>
            ...
            <div className='w-full md:w-1/2 xl:w-1/3 p-6'>
              ...
              <div
                ...
                <div className='flex flex-row items-center'>
                  <div className='flex-shrink pr-4'>
                    <div className='rounded-full p-5 bg-blue-600'><i className='fas fa-server fa-2x fa-inverse' />
                    </div>
                  </div>
                  <div className='flex-1 text-right md:text-center'>
              ...
              <div
                ...
                <div className='flex flex-row items-center'>
                  ...
                  <div className='flex-1 text-right md:text-center'>
                    ...
                    <h3 className='font-bold text-3xl'>3 <span className='text-red-500'>
                      <i className='fas fa-caret-up' /></span>
                    </h3>
                  </div>
                </div>
